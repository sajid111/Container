...
for count in xrange(total_burst_time+1):
   for index in xrange(no_of_process):
      ...
      elif process_queue[index][2]>0 and  process_queue[index][2] <=interrupt and interrupt<=quantum_time and wake_up[index] is 1 : 
      ...
      elif process_queue[index][2]>0 and  process_queue[index][2]>interrupt and interrupt<quantum_time and waiting_queue[index][0] is 0  :
